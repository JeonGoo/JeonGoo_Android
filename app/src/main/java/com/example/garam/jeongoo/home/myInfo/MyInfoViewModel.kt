...
class MyInfoViewModel : ViewModel() {
    ...
    fun getInterestedList() {
        networkService.findInterestProduct(userId.value!!.toInt()).enqueue(object : Callback<ResponseProductsData>{

            override fun onFailure(call: Call<ResponseProductsData>, t: Throwable) {

            }

            override fun onResponse(call: Call<ResponseProductsData>, response: Response<ResponseProductsData>) {
                val res = response.body()!!
