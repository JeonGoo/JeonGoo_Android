...
import com.example.garam.jeongoo.databinding.ActivityPurchasedListBinding

class PurchasedListActivity : AppCompatActivity() {

    private lateinit var binding : ActivityPurchasedListBinding
    private lateinit var viewModel: MyInfoViewModel

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = DataBindingUtil.setContentView(this,R.layout.activity_purchased_list)
